...
export const selectErrorState = createFeatureSelector<fromError.State>('error');
export const selectError = createSelector(selectErrorState, state => state as Error);
